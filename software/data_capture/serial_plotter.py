...
import argparse
import csv  # Importa a biblioteca para salvar CSV
...
if FILENAME:
    try:
        ...
        # CORREÇÃO 1: Delimitador ; para Excel
        csv_writer = csv.writer(csv_file, delimiter=';') 
        
        # CORREÇÃO 2: Cabeçalho com unidades
        ...
        # ESTE BLOCO ESTAVA FALTANDO E CAUSANDO O ERRO
...
try:
    ...
    if csv_file: # Se o arquivo foi aberto mas a serial falhou, feche-o
        csv_file.close()
    exit()
...
try:
    ...
    ser.close()
    if csv_file: # Fecha o arquivo CSV
        csv_file.close()
